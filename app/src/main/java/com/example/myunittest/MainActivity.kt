    ...
    override fun onClick(v: View?) {
        ...
        when{
            TextUtils.isEmpty(length) ->{
                activityMainBinding.edtLength.error= "This field cant be null"
            }
            TextUtils.isEmpty(width) ->{
                activityMainBinding.edtWidth.error= "This field cant be null"
            }
            TextUtils.isEmpty(height) ->{
                activityMainBinding.edtHeight.error= "This field cant be null"
            }
